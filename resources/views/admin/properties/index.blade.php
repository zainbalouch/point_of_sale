...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Properties</h4>
                ...
                <div class="row g-3">
                    <div class="col-xl-12 col-sm-6">
                        <div class="search-box">
                            <input type="text" class="form-control search" placeholder="Search properties">
            ...
            <div class="card-header d-flex align-items-center">
                ...
                <div class="flex-shrink-0">
                    <div class="d-flex flex-wrap align-items-start gap-2">
                        ...
                        <a href="{{ route('admin.properties.create') }}" type="button" class="btn btn-primary add-btn"><i class="bi bi-plus-circle align-baseline me-1"></i> Add Property</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive table datatable">
                    <table id="properties-table" class="display table table-bordered table-nowrap table-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
...
<script>
    $(document).ready(function() {
        ...
        $('#data-table-search').keyup(function() {
            propertiesTable.search(this.value).draw();
        });
