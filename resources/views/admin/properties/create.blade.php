...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Create property</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="description" class="form-control @error('description') is-invalid @enderror" id="description" placeholder="Enter opportunity description" name="description" required autocomplete="description" autofocus>{{ old('description') }}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                                            </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('space_sqm') is-invalid @enderror" id="space-sqm" placeholder="Enter space (SQM)" name="space_sqm" value="{{ old('space_sqm') }}" required autocomplete="space_sqm" autofocus>
                                        @error('space_sqm')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('number_of_rooms') is-invalid @enderror" id="number-of-rooms" placeholder="Enter number of rooms" name="number_of_rooms" value="{{ old('number_of_rooms') }}" required autocomplete="number_of_rooms" autofocus>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('price_per_night') is-invalid @enderror" id="price-per-night" placeholder="Enter price per night" name="price_per_night" value="{{ old('price_per_night') }}" required autocomplete="price_per_night" autofocus>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('city_id') is-invalid @enderror" id="city-id" name="city_id">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('max_guests') is-invalid @enderror" id="max-guests" placeholder="Enter maximum number of guests" name="max_guests" value="{{ old('max_guests') }}" required autocomplete="max_guests" autofocus>
                                        @error('max_guests')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('street') is-invalid @enderror" id="street" placeholder="Enter street name" name="street" value="{{ old('street') }}" required autocomplete="street" autofocus>
                                        @error('street')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('full_address') is-invalid @enderror" id="full-address" placeholder="Enter full address" name="full_address" value="{{ old('full_address') }}" required autocomplete="full_address" autofocus>
                                        @error('full_address')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('latitude') is-invalid @enderror" id="latitude" placeholder="Enter property latitude" name="latitude" value="{{ old('latitude') }}" required autocomplete="latitude" autofocus>
                                        @error('latitude')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('longitude') is-invalid @enderror" id="longitude" placeholder="Enter property longitude" name="longitude" value="{{ old('longitude') }}" required autocomplete="latitude" autofocus>
                                        @error('longitude')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('postal-code') is-invalid @enderror" id="postal-code" placeholder="Enter property postal code" name="postal_code" value="{{ old('postal_code') }}" autocomplete="postal_code" autofocus>
                                        @error('postal_code')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>
...
<script type="text/javascript">
    ...
    function initMap() {
        map = L.map('map').setView([24.6389160, 46.7160104], {{ $mapZoom }});
    ...
    function showPosition(position) {
        ...
        marker = L.marker(currentLocation, { draggable: true, icon: locationIcon })
