...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Edit amenity</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Enter name" name="name" value="{{ old('name', $amenity->name) }}" required autocomplete="name" autofocus>
                                @error('name')
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('amenity_category_id') is-invalid @enderror" id="amenity-category-id" name="amenity_category_id" data-choices data-choices-search-true>
                                    ...
                                    <option value="{{ $amenityCategory->id }}" {{ old('amenity_category_id', $amenity->amenity_category_id) == $amenityCategory->id ? 'selected' : '' }}>
